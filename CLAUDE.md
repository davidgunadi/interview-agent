...
- `questions.pdf` / `summary.pdf` — generated by `.claude/scripts/md_to_pdf.py` from the corresponding `.md` file; regenerate after any edit to the markdown rather than editing the PDF
...
- A **functional change** is any edit to `.claude/agents/*`, `.claude/scripts/*`, skill files, `roles/_behavioral_question_bank.md`, or the workflow itself — i.e. the tool's behavior changes.
